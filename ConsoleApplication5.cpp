...
int main()
{
    ...
    for (int g = 0; g < 10; g++) {
        ...
        LabelBeschleunigung[g]->setSize(120, 20);
    ...
    Label4->setPosition(50.f, 170.f);
    Label4->setSize(400, 20);
    Label4->setTextSize(13);
    Label4->setText("Zufaelliger Ampelabstand");
    ...
    Button1->setPosition(100.f, 185.f);
    ...
    BoxAmpelabstand->setPosition(50.f, 232.f);
    ...
    Button2->setPosition(100.f, 265.f);
